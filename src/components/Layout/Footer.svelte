    ...
    <div class="container">
        <div class="navigation">
            ...
            <div class="section">
                ...
                <span>Notarial oversight</span>
                <span>Participating in the auction</span>
                <span>Trustworthy business</span>
            </div>
            <div class="section">
                <h3>Seller Resources</h3>
                <span>Photography advice</span>
                <span>Self auctioning</span>
...
<style lang=scss>
    ...
    .cta .select-wrapper select {
        ...
        position: relative;
        color: $footer-base-color;
        background: none;
        height: $btn-height;
        padding-right: $btn-padding-inline * 2;
        border: $btn-border-size solid $gray-regular;
        padding-left: $btn-gap;
