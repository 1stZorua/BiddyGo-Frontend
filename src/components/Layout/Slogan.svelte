<script>
    ...
    import collaboration from "$lib/collaboration.png";
...
<section class="slogan">
    <div class="display">
        <div class="square-container">
            <div class="element">
                <Square --size="125px" --background="#159895" --radius="10px"></Square>
            </div>
            <div class="element">
            ...
            <div class="element">
                <div class="square">
                    <SecondaryText --color="white">Total Biddies</SecondaryText>
                    <span>700K</span>
                </div>
            </div>
        </div>
...
<style lang=scss>
    .slogan {
        ...
        align-items: center;
        width: 100%;
        height: $section-height-normal;
        color: $secondary;

        &::before {
            content: '';
            position: absolute;
            background: $section-regular;
            width: 100%;
            z-index: -1;
            height: $section-height-normal;
            left: 0;
    ...
    .square-container .element {
        ...
        &:last-child {
            ...
            .square {
                ...
                height: 200px;
                width: 200px;
                border-radius: $btn-border-radius-medium;
            }
    ...
    @media (max-width: $screen-wide) {
        .slogan {
            flex-direction: column;
            height: calc($section-height-normal * 0.75);

            &::before {
                background-image: url('$lib/collaboration.png');
